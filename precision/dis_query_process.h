...
vector <unsigned int> set_of_s_intersection(
    vector<std::string>& mkw_bin,
    vector<std::string> &db_mkw,
    vector<std::set<unsigned int>> &meta_db,
    std:: vector<unsigned int> &frequency
    );

int DB_ConvertQueryToMetaKeyword(
